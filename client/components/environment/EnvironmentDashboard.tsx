    ...
    <div className="animate-in slide-in-from-right-4 duration-500 min-h-screen bg-emerald-50/30 dark:bg-[#050c08] font-sans pb-32">
      ...
      <div className="p-4 lg:p-8 max-w-6xl mx-auto space-y-12 lg:space-y-16 mt-4 lg:mt-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
           ...
           <div className="col-span-1 bg-white dark:bg-[#121b16] rounded-[2rem] p-6 shadow-sm border border-emerald-100 dark:border-emerald-900/30 flex flex-col items-center justify-center text-center max-h-[300px] sticky top-8 group hover:-translate-y-1 transition-transform duration-300">
